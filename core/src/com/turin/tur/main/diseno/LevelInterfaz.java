...
public class LevelInterfaz {
	...
	public void renderTitle (SpriteBatch batch, OrthographicCamera cameraGUI) {
		...
		Assets.instance.fonts.defaultFont.draw(batch, "Faltan "+(40-levelInfo.levelLog.trialsVisited.size)+" trials", cameraGUI.viewportWidth*4/5, cameraGUI.viewportHeight*9/10);
